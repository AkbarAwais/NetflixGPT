...
const MovieList = ({ title, movies }) => {
    ...
    return (
        <div className=''>
            ...
            <div className='w-full sm:px-8 pl-2 md:ml-10 mt-12 overflow-x-scroll relative group-hover:overflow-hidden scrollbar-hide overflow-y-hidden hover:scrollbar-custom scroll-smooth space-y-4 p-4 '>
