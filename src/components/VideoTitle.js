...
const VideoTitle = ({ title, overview }) => {
    ...
    return (
        <div className='w-screen aspect-video pt-52 px-20 absolute bg-gradient-to-r from-black'>
            <h1 className='text-5xl font-extrabold text-white'>{title}</h1>
            <div className='text-2xl w-1/3 p-4 text-justify text-white'>{overview}</div>
