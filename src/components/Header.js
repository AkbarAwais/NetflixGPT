    ...
    return (
        <div className="sticky inset-0 z-10 ">
            <header className='w-[100%] absolute z-10'>
                <div className='box-border bg-gradient-to-b from-black flex justify-between items-center sticky inset-0'>
                    ...
                    <div className='text-yellow-300 font-bold mr-10 text-2xl text-left cursor-default'>
                        ...
                        {user &&
                            <div className='inline-block mr-8 p-6 text-xl text-white transition-all duration-200 ease-in-out hover:scale-[1.1] font-bold cursor-pointer text-right' onClick={handleSignOut}>
                                Sign out
                            </div>}
                    </div>
