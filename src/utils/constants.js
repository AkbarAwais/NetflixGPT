...
export const FULL_SCREEN_TRAILER_URL = (trailerId) => `https://www.youtube.com/embed/${trailerId}?&autoplay=1&modestbranding=1&controls=1&loop=1&rel=0&playlist=${trailerId}`;
